...
void box_grasp(MatrixArray& frame_array, VectorArray& position_array,
               ...
               double finger_len=0.035, double finger_gap=0.12, double slice_step=0.025, bool bb_pruning=true);
/*
...
void can_grasp(MatrixArray& frame_array, VectorArray& position_array,
               std::string filename, double scale, std::vector<bool>& block_list,
               double finger_len=0.035, double finger_gap=0.12, int num_angle=8, double slice_step=0.025, bool bb_pruning=true);
