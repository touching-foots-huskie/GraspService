...
void box_grasp(MatrixArray& frame_array, VectorArray& position_array,
               std::string filename, double scale, double finger_len=0.06, int num_slice=2);
void can_grasp(MatrixArray& frame_array, VectorArray& position_array,
               std::string filename, double scale, double finger_len=0.06, int num_angle=8, int num_slice=2);
